...
rm_vertexes = modify(adj_time, Vertex)

# Print results if modification was successful
if rm_vertexes:
    print(f"Remove vertexes: {Vertex}")
    print(f"Before rm global reachable rate is {rm_vertexes[0][0]}, before avg latency is {rm_vertexes[0][1]}")
    print(f"After rm global reachable rate is {rm_vertexes[1][0]}, after rm avg latency is {rm_vertexes[1][1]}")
    print(f'Adj list after remove vertexes:{rm_vertexes[2]}')
    print("="*20)
...
# Call the modify function
rm_edges = modify(adj_time, Vertexes=None, Edges=Edges)

# Print results if modification was successful
if rm_edges:
    print(f"Remove edge(s): {Edges}")
    print(f"Before rm global reachable rate is {rm_edges[0][0]}, before avg latency is {rm_edges[0][1]}")
    print(f"After rm global reachable rate is {rm_edges[1][0]}, after avg latency is {rm_edges[1][1]}")
    print(f'Adj list after remove edges:{rm_edges[2]}')
    print("="*20)
